  ...
  return (
    <>
      ...
      <p>
        ...
        of a community of passionate of readings, of every genre of books, that
        take this opportunity to discover new opus and discuss about their
        favourites. This is an MVP that can be largely improved. Our vision for
        improvements: adding localisation and being able to filter available
        books to borerow around you, creating a forum to discuss, adding books
        to your favourites, being able to follow other users to be updated on
        their activities, organise events...many other possibilities are opened!
        Enjoy!
      </p>
      ...
      <div>
        ...
        else’s shoes for a while. — Malorie Blackman
      </div>
    </>
  );
}
