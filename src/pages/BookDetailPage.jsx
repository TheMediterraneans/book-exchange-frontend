    ...
    <div style={{ padding: "20px", maxWidth: "800px" }}>
      ...
      <div style={{ display: "flex", gap: "20px", marginBottom: "20px" }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <p>
            <strong>Published Year:</strong> {book.publishedYear || "Unknown"}
          </p>
          <p>
          ...
          <p>
            <strong>Source:</strong> {book.source || "External"}
          </p>
          ...
          <>
            {user && (
              ...
              >
                ...
                >
                  Choose how many days you're willing to lend this book (1-30
                  days)
                </small>
              </div>
            )}
              ...
              if (isLoggedInContext && availableCopies.length > 0) {
                ...
                const ownedCopies = availableCopies.filter(
                  (copy) =>
                    ...
                    copy.owner?._id === currentUserId
                );
                const borrowableCopies = availableCopies.filter(
                  (copy) =>
                    copy.owner !== currentUserId &&
                    copy.owner?._id !== currentUserId
                );
                ...
                if (ownedCopies.length > 0) {
                  return (
                    <div>
                      <p style={{ color: "#28a745", fontWeight: "bold" }}>
                        ✓ You own {ownedCopies.length}{" "}
                        {ownedCopies.length === 1 ? "copy" : "copies"} of this
                        book
                      </p>
                      <p style={{ color: "#6c757d" }}>
                        This book is in your lending library. You can view and
                        manage your copies in "My Books".
                      </p>
                      <button
                  ...
                  return (
                    <div>
                      <p style={{ color: "#007bff", fontWeight: "bold" }}>
                        📚 {borrowableCopies.length}{" "}
                        {borrowableCopies.length === 1
                          ? "copy is"
                          : "copies are"}{" "}
                  ...
                  return (
                    <div>
                      ...
                      <p style={{ color: "#6c757d" }}>
                        This book is not currently available in our lending
                        network.
                      </p>
                    </div>
                  );
                  ...
                  return (
                    <div>
                      <p style={{ color: "#ffc107", fontWeight: "bold" }}>
                        📚 {availableCount}{" "}
                        {availableCount === 1 ? "copy is" : "copies are"}{" "}
                        available for borrowing
                      </p>
                      <p style={{ color: "#6c757d" }}>
                        Please log in to see copy details and make a
                        reservation.
                      </p>
                      <button
              ...
              // Fallback for cases where copy information is not available
                ...
                return (
                  <div>
                    ...
                    <p style={{ color: "#6c757d" }}>
                      Copy availability information is not available in this
                      view.
                    </p>
                  </div>
                );
