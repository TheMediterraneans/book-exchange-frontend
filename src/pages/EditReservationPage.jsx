      ...
      <div>
        ...
        >
          {reservation.book?.title ||
            `Book Copy #${reservation.book?._id?.slice(-6)}`}
        </h2>
        ...
        >
          ...
          {reservation.book?.owner?.email && reservation.book?.owner?.name && (
            <p>
              <strong>Owner Email:</strong> {reservation.book.owner.email}
            </p>
          )}
          <p>
          ...
          <p>
            <strong>Maximum Allowed Duration:</strong> {maxAllowedDays} days
          </p>
        </div>
      </div>
