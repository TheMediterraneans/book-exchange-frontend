  ...
  const fetchMyBooks = async () => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_SERVER_URL}/api/mybooks/`,
        {
          headers: {
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div>
        ...
        {myBooks.length === 0 ? (
          <p>
            You don't have any books in your library yet. Add your first book!
          </p>
        ) : (
      ...
      <section>
        ...
        {reservationsError && (
          <div
            style={{ color: "red", padding: "10px", backgroundColor: "#fee" }}
          >
            {reservationsError}
          </div>
        )}
                    ...
                    <div className="book-info">
                      ...
                      <h3 className="book-title">
                        {reservation.book?.title ||
                          `Reserved Book Copy #${
                            reservation.book?._id?.slice(-6) || "Unknown"
                          }`}
                      </h3>

                      {reservation.book?.authors &&
                        reservation.book.authors.length > 0 && (
                      ...
                      {reservation.book?.owner ? (
                        <p className="book-owner">
                          <strong>Owner:</strong>{" "}
                          {reservation.book.owner.name ||
                            reservation.book.owner.email ||
                            "Unknown"}
                        </p>
                      ) : (
                        <p className="book-owner">
